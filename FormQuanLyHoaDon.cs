...
namespace QLBV
{
     ...
     */
        ...
        private void cbbDSHD_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            lbTienBaoHiem.Text = "-" + dtHD.Rows[0][4].ToString();
            lbTienDichVu.Text = dtHD.Rows[0][1].ToString();
            lbTienKham.Text = dtHD.Rows[0][0].ToString();
            lbTongTien.Text = dtHD.Rows[0][2].ToString();
